...
export const LAYER_PRESETS: Record<string, (keyof MapLayers)[]> = {
  ...
  fireWeatherRisk: ['fires', 'weather', 'ciiChoropleth'],
...
export const COMMANDS: Command[] = [
  ...
  { id: 'layers:fireWeatherRisk', keywords: ['fires weather risk', 'fire weather risk', 'wildfire weather', 'fwties kairos epikindinothta', 'fwties kairo provlepsi kai keravnous'], label: 'Show fires + weather + risk layers', icon: '\u{1F525}', category: 'layers' },
  ...
  { id: 'layer:fires', keywords: ['fires', 'wildfires', 'foties', 'fwties'], label: 'Toggle satellite fires', icon: '\u{1F525}', category: 'layers' },
  { id: 'layer:weather', keywords: ['weather', 'forecast', 'kairo', 'kairos', 'provlepsi kairou', 'keravnous'], label: 'Toggle weather overlay', icon: '\u{1F324}\uFE0F', category: 'layers' },
  ...
  { id: 'layer:cii', keywords: ['cii', 'instability index', 'country instability', 'risk', 'epikindinothta', 'epikindynothta'], label: 'Toggle CII instability', icon: '\u{1F30E}', category: 'layers' },
  ...
  { id: 'panel:strategic-risk', keywords: ['risk', 'strategic risk', 'threat level', 'pinakas epikindinothtas'], label: 'Panel: Strategic Risk', icon: '\u26A0\uFE0F', category: 'panels' },
  ...
  { id: 'panel:forecast', keywords: ['forecast', 'ai forecast', 'predictions ai', 'provlepsi kairou'], label: 'Panel: AI Forecasts', icon: '\u{1F52E}', category: 'panels' },
